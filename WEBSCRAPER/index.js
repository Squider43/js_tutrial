...
axios(URL).then((response) => {
    ...
    $(".LoopList__item", htmlParser).each(function () { //htmlParserから探す
        const title = $(this).find(".SearchResultItemTitle_SearchResultItemTitle__name__N_aB9").text(); //titleクラスを探して、その内部を出力
...
app.listen(PORT, console.log("server warning!"));
